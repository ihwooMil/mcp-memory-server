# Long-Term Memory 프로젝트 정리

> 작성일: 2026-02-28 | v0.1.0 → v0.3.0 (2026-03-01 이름 변경: mcp-memory-server → long-term-memory)

## 1. 프로젝트 개요

**Long-Term Memory System** — AI 어시스턴트에 영구적이고 자기 관리되는 장기 기억을 부여하는 시스템.
